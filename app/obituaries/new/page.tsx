...
export default function NewTributePage() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-8">
      <h1 className="text-2xl font-semibold">Create Obituary</h1>
      <div className="mt-6 space-y-6">
            ...
            <div>
              ...
              {portrait && (
                <img
                  ...
                  alt="portrait"
                  className="h-40 rounded-md mt-2 object-cover"
                />
              )}
            </div>
            <div>
        ...
        {step === 5 && (
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm">Allow public obituaries?</label>
              <Select
                value={allowPublic ? "yes" : "no"}
                onValueChange={(v) => setAllowPublic(v === "yes")}
              >
                <SelectTrigger>
        ...
        <div className="flex items-center justify-between">
          ...
          {step < 5 ? (
            ...
            <Button onClick={onSubmit} disabled={!canNext || saving}>
