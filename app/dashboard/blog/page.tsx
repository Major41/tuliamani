          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Guidance, support, and insights on grief, legacy, and
                remembrance
              </p>
            </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Articles and guides to help you navigate the grieving
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Connect with others and find comfort in shared experiences
                    and memories.
                  </p>
                </div>
              </div>
